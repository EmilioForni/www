    ...
    <div class="section">
      <div class="container">
		...
		<div class="row text-center">	
			<div class="text-center mx-auto col-10">
				<center>
					<h2> Clientes y Servicios Contratados </h2>			
					<?php
						// Seleccionamos la tabla con la que vamos a trabajar
						$tabla="clientes_has_servicios";// Escribir entre comillas el nombre de la tabla a listar

						// Establecemos la sentencia SQL de la Consulta a realizar
						$sentencia="SELECT c.Nombre, c.Apellidos, s.Servicio, s.PrecioServicio, chs.fecha_contratacion FROM clientes_has_servicios chs
						INNER JOIN clientes c ON chs.DNI_cliente = c.DNI
						INNER JOIN servicios s ON chs.idServicio = s.idServicio";
